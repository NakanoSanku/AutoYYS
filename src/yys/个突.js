...
let breakRegion = [[250, 150, 450, 250], [580, 150, 750, 250], [900, 150, 1100, 250],
[250, 290, 450, 400], [580, 290, 750, 400], [900, 290, 1100, 400],
[250, 420, 450, 530], [580, 420, 750, 530], [900, 420, 1100, 530]
        ...
        if (findImg(formula)) {
            if (res) {
                for (index = 0; index < Breach.length; index++) {
                    beat = { 'template': './assets/img/突破/已突破.bmp', 'region': Breach[index], 'threshold': 0.6 }
                    console.log('1');
